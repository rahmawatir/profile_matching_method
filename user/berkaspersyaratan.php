    ...
    <div class="row m-t-20">
        <div class="col-sm-6">
            <div class="form-group">
                <label for="username">Foto Diri (<b><i>.jpg/.png</i></b>)</label>
                <input type="file" class="filestyle" required="" id="fotoDiri" accept="image/png, image/jpeg" data-buttonname="btn-default" name="fotoDiri" class="form-control">
                <?php if($ss==1 && $diri!=""){echo "<b><p><a href=\"berkas/$diri\" target=\"_blank\">Click Here to Check File!</a></p></b>";} ?>
            </div>

            <div class="form-group">
                <label for="username">Kartu Keluarga (KK) (<b><i>.pdf</i></b>)</label>
            ...
            <div class="form-group">
                <label for="username">Kartu Tanda Penduduk (KTP) (<b><i>.pdf</i></b>)</label>
            ...
            <div class="form-group">
                <label for="username">Kartu Tanda Mahasiswa (<b><i>.pdf</i></b>)</label>
            ...
            <div class="form-group">
                <label for="username">Curriculum Vitae / Daftar Riwayat Hidup (<b><i>.pdf</i></b>)</label>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label for="username">Surat Pernyataan (<b><i>.pdf</i></b>)</label>
            ...
            <div class="form-group">
                <label for="username">Surat Rekomendasi Tokoh (<b><i>.pdf</i></b>)</label>
            ...
            <div class="form-group">
                <label for="username">Surat Keterangan Aktif Kuliah (<b><i>.pdf</i></b>)</label>
            ...
            <div class="form-group">
                <label for="username">Transkrip Nilai Terakhir (<b><i>.pdf</i></b>)</label>
            ...
            <div class="form-group">
                <label for="username">Portofolio (<b><i>.pdf</i></b>)</label>
